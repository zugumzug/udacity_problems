...
def gruesome(str):
	blueexp = r'[a-zA-Z]*b[a-zA-Z]*t[a-zA-Z]*'
	greenexp = r'[a-zA-Z]*t[a-zA-Z]*g[a-zA-Z]*'
	blue = re.findall(blueexp, str)
	green = re.findall(greenexp, str)
	green = [x for x in green if x not in blue]
	return blue + green
